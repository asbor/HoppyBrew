...
def upgrade() -> None:
    ...
    with op.batch_alter_table('water', schema=None) as batch_op:
        ...
        batch_op.alter_column('calcium', type_=Numeric(8, 2), nullable=False, server_default='0')
        batch_op.alter_column('magnesium', type_=Numeric(8, 2), nullable=False, server_default='0')
        batch_op.alter_column('sodium', type_=Numeric(8, 2), nullable=False, server_default='0')
        batch_op.alter_column('chloride', type_=Numeric(8, 2), nullable=False, server_default='0')
        batch_op.alter_column('sulfate', type_=Numeric(8, 2), nullable=False, server_default='0')
        batch_op.alter_column('bicarbonate', type_=Numeric(8, 2), nullable=False, server_default='0')
        
        # Alter pH to use Decimal
        batch_op.alter_column('ph', type_=Numeric(4, 2), nullable=True)
        
        # Add additional water properties
        batch_op.add_column(sa.Column('total_alkalinity', Numeric(8, 2), nullable=True))
        batch_op.add_column(sa.Column('residual_alkalinity', Numeric(8, 2), nullable=True))
