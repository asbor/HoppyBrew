...
class Settings:
    ...
    def __init__(self):
        ...
        self.DATABASE_PASSWORD: str = os.getenv(
        ...
        self.API_RELOAD: bool = os.getenv(
            "API_RELOAD", "true").lower() == "true"
        ...
        # External APIs
        self.HOMEBREWING_API_KEY: Optional[str] = os.getenv(
            "HOMEBREWING_API_KEY")
        ...
        # Production Security
        self.PRODUCTION: bool = os.getenv(
            "PRODUCTION", "false").lower() == "true"
        self.SSL_REDIRECT: bool = os.getenv(
            "SSL_REDIRECT", "false").lower() == "true"
        ...
        self.BACKUP_ENABLED: bool = os.getenv(
            "BACKUP_ENABLED", "false").lower() == "true"
    ...
    def _validate_settings(self):
        ...
        if self.PRODUCTION and self.SECRET_KEY == "dev-secret-key-change-in-production-must-be-32-chars-minimum":
...
if not settings.is_production and settings.SECRET_KEY == "dev-secret-key-change-in-production-must-be-32-chars-minimum":
    import warnings
    warnings.warn(
