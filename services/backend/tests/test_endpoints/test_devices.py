...
def test_get_all_devices(client):
    ...
    # Create two devices
    device1 = {"name": "Device 1", "device_type": "ispindel", "is_active": True}
    device2 = {"name": "Device 2", "device_type": "tilt", "is_active": False}
...
def test_update_device(client):
    ...
    # Create device
    payload = {"name": "Original Name", "device_type": "ispindel", "is_active": True}
    create_resp = client.post("/devices", json=payload)
    device_id = create_resp.json()["id"]

    # Update device
    update_payload = {"name": "Updated Name", "is_active": False}
...
def test_delete_device(client, db_session):
    ...
    # Create device
    payload = {"name": "Device to Delete", "device_type": "ispindel", "is_active": True}
    create_resp = client.post("/devices", json=payload)
    device_id = create_resp.json()["id"]
