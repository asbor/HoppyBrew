...
def test_create_fermentation_reading(client, db_session):
    ...
    response = client.post(
        f"/batches/{batch_id}/fermentation/readings", json=reading_payload
    )
...
def test_get_fermentation_readings(client, db_session):
    ...
    for reading_data in readings_data:
        response = client.post(
            f"/batches/{batch_id}/fermentation/readings", json=reading_data
        )
...
def test_update_fermentation_reading(client, db_session):
    ...
    update_response = client.put(
        f"/fermentation/readings/{reading_id}", json=update_payload
    )
...
def test_delete_fermentation_reading(client, db_session):
    ...
    assert (
        delete_response.json()["message"] == "Fermentation reading deleted successfully"
    )
...
def test_cascade_delete_fermentation_readings(client, db_session):
    ...
    readings = (
        db_session.query(models.FermentationReadings).filter_by(batch_id=batch_id).all()
    )
