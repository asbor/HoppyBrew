  ...
  <div class="min-h-screen bg-background text-foreground p-8">
    ...
    <div class="flex gap-4 mb-6">
      <div class="flex-1">
        <Input 
          v-model="searchQuery" 
          placeholder="Search fermentables by name, type, origin..." 
    ...
    <!-- Error State -->
    <div v-else-if="fermentablesError" class="bg-destructive/10 border border-destructive text-destructive px-4 py-3 rounded">
    ...
    <div v-else class="bg-card rounded-lg border border-border overflow-hidden">
      <Table>
        ...
        <TableBody>
          <TableRow 
            v-for="ferm in filteredFermentables" 
            :key="ferm.id"
            ...
            <TableCell>
              <div class="flex items-center gap-2">
                <div 
                  ...
                  :style="{ backgroundColor: srmToRgb(ebcToSrm(ferm.color)) }"
                ></div>
      ...
      <DialogContent class="bg-card border-border max-w-2xl">
        ...
        <div class="grid grid-cols-2 gap-4 py-4">
          <div class="col-span-2">
            ...
            <Input id="name" v-model="formData.name" placeholder="e.g., Pilsner Malt" class="bg-background border-input" />
          </div>
          ...
          <div>
            ...
            <Input id="origin" v-model="formData.origin" placeholder="e.g., Germany" class="bg-background border-input" />
          </div>

          <div>
            <Label for="supplier">Supplier</Label>
            <Input id="supplier" v-model="formData.supplier" placeholder="e.g., BrewStore" class="bg-background border-input" />
          </div>
